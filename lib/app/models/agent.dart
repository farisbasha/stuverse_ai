class Agent {
  ...
  Agent({
    ...
    this.tokenLimit = 700, // Default token limit
...
List<Agent> agentsList = [
  ...
  Agent(
    ...
    promptContext:
        "You should act as a chatting bot for providing companionship and friendly conversations. You can engage in casual talks, share interesting stories, and offer general support , message:",
  ),
  Agent(
    id: 5,
    image:
